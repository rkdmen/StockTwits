...
class SingleUserMsg extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <p className="singleMsgByUserId">
          {!this.props.userMsg ? (
            <span className="selectUserToSeeMore">{selectUserSpan}</span>
          ) : (
            <span>Twits by {this.props.userMsg.selectedUser}</span>
          )}
        </p>
                ...
                return (
                  <div className="singleMsgByUser" key={i}>
                    ...
                    <p className="timeStamp">
                      {this.UTCtoLocal(msg.created_at)}
                    </p>
                    <hr />
                  </div>
                );
